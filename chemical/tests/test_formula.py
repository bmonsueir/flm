...
class FormulaModelTest(TestCase):
    ...
    def test_project_ordering(self):
        ...
        formula1 = Formula.objects.create(project=project1, name='i1')
        formula2 = Formula.objects.create(project=project1, name='formula 2')
        formula3 = Formula.objects.create(project=project1, name='3')
        self.assertEqual(
    ...
    def test_string_representation(self):
        formula = Formula(name='some text')
